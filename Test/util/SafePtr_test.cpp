...
IUTEST(util, SafePtr)
{
	...
	{ [[maybe_unused]] tofu::SafePtr<void> ptr_; }
	{ [[maybe_unused]] tofu::SafePtr<const void> ptr_; }
	{ [[maybe_unused]] tofu::SafePtr<int> ptr_; }
	{ [[maybe_unused]] tofu::SafePtr<const int> ptr_; }
